...
class Single extends Model
{
    ...
    {
        Model::query('SELECT * FROM comment WHERE id_product=:id_product');
        Model::bind('id_product', $id);
        return Model::resultSet();
    }
    ...
    {
        Model::query("INSERT INTO comment (name, email, id_product, comment) VALUES (:name, :email, :id_product, :comment)");
